...
public class GoRockBeeCrawler extends Crawler {
	...
	public void run(CrawlerDTO crawlerDTO, String url) throws Exception {
		...
		for(Element a : body.select("aside#categoryEventsContainer section.rowline h4 > a")) {
			String link = "http://www.gorockbee.com" + a.attr("href");
